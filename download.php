                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="single-blog-post mb-50 wow fadeInUp" data-wow-delay="500ms">
                                    ...
                                    <p class="post-title">Downloads</p>
                                    <!-- Post Meta -->
                                    <?php
                                    include 'dbh.php';
                                    ...
                                    $last = "SELECT id FROM downloads ORDER BY id DESC LIMIT 1";
                                    ...
                                    if ($row = mysqli_num_rows($result) > 0) {
                                        while ($row = mysqli_fetch_assoc($result)) {
                                            ...
                                            ?>
                                            <div class="post-meta">
                                                <li><a class="blink" href="./downloads/<?php echo $row['link']; ?>"><?php echo $row['title']; ?></a></li>
                                            </div>
                                            <?php
                                            }
                                            else
                                            ...
                                            ?>
                                            <div class="post-meta">
                                                <li><a href="./downloads/<?php echo $row['link']; ?>"><?php echo $row['title']; ?></a></li>
                                            </div>
                                            <?php
                                            }
                                        }
                                    } else {
                                        echo "<p>No Download</p>";
                                    }
                                    ?>
