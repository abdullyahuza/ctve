                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-7">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4">Upload Image</h3>
                                    </div>
                                            ...
                                            <div class="form-row-">
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="form-group mt-4 mb-0">
                                                        <input type="submit" class="btn btn-success" name="UploadImage" id="AddImage" value="Upload File" />
                                                    </div>
                                                </div>
                                            </div>
                                        </form>
