                            ...
                            <div class="col-lg-7">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                            ...
                                            <div class="form-row-">
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="form-group mt-4 mb-0">
                                                        <input type="submit" class="btn btn-success" name="UploadFile" id="AddFile" value="Upload File" />
                                                    </div>
                                    ...
                                    <div class="card-footer text-center">
                                        <div class="small"><b>Note:</b> This form will upload a file. Take note of the file name and extension.</div>
                                        <div class="small"><b>file link:</b> /ctve1/staff/<?php echo $user->data()->username; ?>/files/fileName.extension</div>
                                    </div>
                                </div>
                            </div>
                        </div>
