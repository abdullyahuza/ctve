        <a class="nav-link collapsed" href="home" data-toggle="collapse" data-target="#collapseLayouts" aria-expanded="false" aria-controls="collapseLayouts">
        ...
        <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
            <nav class="sb-sidenav-menu-nested nav">
                ...
                <a class="nav-link" href="welcome">Welcome Message</a>
                <a class="nav-link" href="vision">Vision & Mission</a>
                <a class="nav-link" href="news_events">News & Events</a>
                <a class="nav-link" href="quicklinks">Quick Links</a>
            ...
            <nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPages">
                ...
                <div class="collapse" id="pagesCollapseError" aria-labelledby="headingOne" data-parent="#sidenavAccordionPages">
                    <nav class="sb-sidenav-menu-nested nav">
                        ...
                        <a class="nav-link" href="add_staff">Add Staff</a>
                    </nav>
                </div>
            </nav>
        </div>
        ...
        <a class="nav-link" href="uploadimage">
