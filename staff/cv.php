            ...
            <div class="row">
                ...
                <main class="col-md-7">
                    <h1 style="text-align: center; margin-bottom: -25px;">CV</h1>
                        <a class="float-right mb-1 small text-muted text-right" href="../<?php echo $data->username; ?>/<?php echo $data->username; ?>.pdf" target="_blank">
                            Open 
                        ...
                        <div class="embed-responsive embed-responsive-85by110 mt-1">
                            <iframe class="b-0 embed-responsive-item" src="../assets/pdfjs-2.5.207/web/viewer.html?file=/<?php echo $projectDirName; ?>/staff/<?php echo $data->username; ?>/<?php echo $data->username; ?>.pdf#pagemode=none"></iframe>
                        </div>
